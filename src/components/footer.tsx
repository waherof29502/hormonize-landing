  ...
  return (
    <footer>
        ...
        <div className="hidden 3md:flex flex-col min-h-[60vh] md:justify-center items-center 3md:items-start 3md:w-[45%] 2lg:w-[36%] wide:w-1/3 lg:pl-2 xl:pl-0 3md:pr-[100px] xl:pr-[180px] ml-auto gap-y-[30px] lg:gap-y-[15px] ">
            <h2 className="text-[30px] sm:text-[44px] 3xl:text-[62px] text-primary font-brandonThin font-light ">
            ...
            <Button containerStyles="ml-auto w-[50%] md:w-[30%] 3md:w-[50%] py-2 lg:py-4 border-primary border-[1px] " path="/contact-us"><span className='text-primary text-[18px] 3xl:text-[24px] font-brandonMed'>leave a message</span></Button>        
        </div>
        {/* mobile contact us*/}
           <div className="3md:hidden flex flex-col min-h-[60vh] md:justify-center items-center ml-auto gap-y-[30px] py-10 px-10">
            <h2 className="text-[30px] sm:text-[44px] text-primary font-brandonThin font-light ">
              CONTACT <span className="font-brandonBld">US</span>
            </h2>
             <span className="text-primary font-medium 3md:font-normal text-[20px] pb-4">
              了解如何用設計為你的生活開拓嶄新視野歡迎與我們聯繫。
            </span>
            <Button containerStyles="ml-auto w-[45%] md:w-[30%] 3md:w-[50%] py-2 lg:py-4 border-primary border-[1px] " path="/contact-us"><span className='text-primary text-[18px] 3xl:text-[24px] font-brandonMed'>leave a message</span></Button>        
        </div>
        </div>
        ...
        <div className="md:hidden flex flex-col justify-between py-4 gap-y-20">
          ...
          <div className="text-[18px] text-primary leading-normal font-brandonLight">
            &copy; HARMONIZE DESIGN 2023.<br/>All Rights Reserved.
            <Link href="https://creer-design.com/" target="_blank">
            Web Design By créer.
            </Link>
          </div>
