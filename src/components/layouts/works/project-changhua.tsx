            ...
            <div ref={ref} className={`w-1/4 h-full flex flex-col bg-[rgb(209,209,209)] border-r-[2px] border-primary`}>
              <div
                className={`3md:scale-50 xl:scale-75 wide:scale-100 ${
                  inView
                    ? 'fixed mt-[8rem] 3md:mt-[2rem] xl:mt-[4rem] 3xl:mt-[8rem] wide:mt-[4rem] wider:mt-[14rem] pb-[6rem] 3md:-ml-[1.25rem] xl:ml-[0.5rem] 2xl:ml-[1rem] 3xl:ml-[3.75rem] wide:ml-[4rem] wider:ml-[10rem] z-20'
            ...
            <div className="w-3/4 h-full flex flex-col relative mt-[15vh]">
              ...
              <div className="mx-auto w-[90%] flex flex-col gap-y-4 pt-1 pb-[6rem]">
                ...
                <span className="text-[#3E3E3E] md:text-[1rem] 3xl:text-[1.25rem] font-sans font-light leading-[2.5rem]">
                  『所謂的住宅，起源於人類最根本的慾望，是呈現人類夢想的地方。真的富裕，並不是單純的便利與舒適，而是，就算在有限的空間之中，也能創造豐富。』---安藤忠雄
                </span>
                <span className="text-[#3E3E3E] md:text-[1rem] 3xl:text-[1.25rem] font-sans font-light leading-[2.5rem]">
                  建築空間，介於都市與室內之間，作為一個生活的容器，作為一個行為的載體，它承載了宏觀與微觀的生活空間的層次。建築位於一個城鎮或都市之中，因為該區域的特色與文化，它表現出獨特的空間形式；也因為居住者的慾望，產生了個人化的空間性質與組合方式，甚至是立面表情。所以，對於都市而言，建築必須與環境對話，以回應「人與都市」的關係，同時，亦必須滿足個人對生活空間的執念與需求，以達到「人與環境」相容共存的場所精神，藉此創造多樣與豐富。
                </span>
                <span className="text-[#3E3E3E] md:text-[1rem] 3xl:text-[1.25rem] font-sans font-light leading-[2.5rem]">
                  本案的透天厝，位於彰化市的一個平靜的小鎮，一連串街屋的最邊間。概念來自於：
                  <br />
                  1. 突破傳統街屋的形式 <br />
                  2. 將自然元素導入室內 <br />
                  3. 置入都市空間 <br />
                ...
                <span className="text-[#3E3E3E] md:text-[1rem] 3xl:text-[1.25rem] font-sans font-light leading-[2.5rem]">
                  透過現代簡約的設計，來強調本案的強烈的存在感，是本設計主要的訴求。主題「四立方」（House
                  4x4x4），代表本案的「四個主要的家庭成」、「四個水平與垂直相連的主要空間」，以及，以「四米為模矩」的分割建築量體的操作手法。空間的調性源自於屋主的鮮明個性，藉此而發展其空間佈局與建築外觀，以呈現「理性於外，感性於內」的內斂性格。
                </span>
                <br />
                <h2 className="text-primary md:text-[1rem] 3xl:text-[1.5rem] font-sans font-medium">背景與訴求</h2>
                <span className="text-[#3E3E3E] md:text-[1rem] 3xl:text-[1.25rem] font-sans font-light leading-[2.5rem]">
                  屋主在國外經商多年，退休回到了家鄉，希望將舊社區中的一棟自宅的舊房子，改建成一幢三層樓的建築物，不僅要生活機能充沛，節能性高效，充滿陽光和樂趣。準確的結構和佈局使四口之家可以共享庭院，客廳，餐廳和廚房等公共區域。
                </span>
                <span className="text-[#3E3E3E] md:text-[1rem] 3xl:text-[1.25rem] font-sans font-light leading-[2.5rem]">
                  從這個安靜的住所望出去，給人一種與世隔絕和孤立的感覺，從外注視這棟小白屋，又十分的與眾不同。退休，就像是走下竸技場至隱居之地，擁抱「侘寂」世界，所營造的空間，是經得起時間考驗的簡約美，有意識的放慢腳步，代表著簡單、安靜的生活方式，開始品嚐生活中的不同階段。
                </span>
                <span className="text-[#3E3E3E] md:text-[1rem] 3xl:text-[1.25rem] font-sans font-light leading-[2.5rem]">
                  它像是一個城市突擊隊般的，帶給這個寧靜且保守，以傳統製造業為主的老舊社區，一陣騷動與波瀾，成為一個建築的話題：它不僅代表一種新的可能，也代表了另一種不同的生活方式，更是一種回應都市、與環境產生互動的生活載體。
                </span>
                <span className="text-[#3E3E3E] md:text-[1rem] 3xl:text-[1.25rem] font-sans font-light leading-[2.5rem]">
                  在小巷弄裡擁有一間低調的生活空間，既獨特又私密，又不失現代便利性。居住者可以在室內，透過挑高的天窗，白天欣賞白雲和陽光，在夜晚觀看月亮和星星，與天地完美和諧地生活，此小宇宙帶來極大的和平與舒適。
                </span>
                <br />
                <br />
