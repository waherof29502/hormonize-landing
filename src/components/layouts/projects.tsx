          ...
          <>
            <div className="w-full flex justify-center items-center scale-90 xl:scale-100 group ">
              <div className="w-1/5 3xl:w-1/4 h-[35vh] flex flex-col justify-center items-center text-primary gap-x-2">
                <div className="w-full h-[44%] wider:h-[20%] flex flex-col justify-center items-center group overflow-hidden">
                  <div className="flex flex-col justify-center items-center">
                    <span className="text-[1.5rem] md:text-[2rem] xl:text-[2.25rem] font-brandonBld uppercase text-shadow ease-linear duration-300 translate-y-5 group-hover:-translate-y-24">
                      {item.category[0]}
                    </span>
                    <span className="text-[1.5rem] md:text-[2rem] xl:text-[2.25rem] font-brandonBld uppercase text-shadow ease-linear duration-300 translate-y-5 group-hover:-translate-y-24">
                      {item.category[1]}
                  ...
                  <span className="text-[1.5rem] md:text-[2rem] xl:text-[2.25rem] font-brandonBld uppercase text-shadow ease-linear duration-300 translate-y-20 group-hover:-translate-y-14">
                    {item.projectTag}
                  </span>
                </div>
              </div>
              ...
              <div className="w-1/4 h-full flex flex-col justify-center gap-y-1 pl-2">
                <Link href={item.path} className="cursor-pointer">
                  <p className="mt-6 font-sans text-[1.5rem] text-primary font-medium tracking-[0.8px] lg:tracking-[0.96px]">
                    {item.title}
                  </p>
                  <div className="flex gap-x-2 items-center pt-1">
                    <span className="text-[1rem] text-primary">{item.icon}</span>
                    <span className="font-sans text-[#3E3E3E] font-syne text-[1rem] tracking-[0.64px] font-light">
                      {item.tag}
                    </span>
                  </div>
                </Link>
                <Button
                  containerStyles="wide:w-1/3 font-brandonMed mt-8 mr-auto border-[1px] border-primary px-5 py-2 text-[1.5rem] text-primary hover:text-white hover:bg-primary"
                  path={item.path}
                >
                  learn more
                </Button>
              ...
              <div className="w-full h-[14vh] flex flex-col justify-center items-center text-primary">
                <div className="w-full h-1/2 flex flex-col justify-center items-center group overflow-hidden">
                  <div className="flex gap-x-2 justify-center items-center">
                    <span className="text-[1.5rem] sm:text-[2.25rem] font-brandonBld uppercase text-shadow ease-linear duration-300 translate-y-5 group-hover:-translate-y-10">
                      {item.category[0]}
                    </span>
                    <span className="text-[1.5rem] sm:text-[2.25rem] font-brandonBld uppercase text-shadow ease-linear duration-300 translate-y-5 group-hover:-translate-y-10">
                      {item.category[1]}
                  ...
                  <span className="text-[1.5rem] sm:text-[2.25rem] font-brandonBld uppercase text-shadow ease-linear duration-300 translate-y-20 group-hover:-translate-y-5">
                    {item.projectTag}
                  </span>
                </div>
              </div>
              <div className="w-[90%] h-[50vh]">
                <Link href={item.path} className="cursor-pointer">
                  <Image
                    ...
                    width={303}
                    height={352}
                    className="object-cover bg-center rounded-[15px] w-full h-full"
                  />
                </Link>
              </div>
              <div className="w-full h-full flex flex-col justify-center px-8 mx-auto">
                <Link href={item.path} className="cursor-pointer">
                  ...
                  <div className="flex gap-x-2 items-center pt-3">
                    ...
                    <span className="font-sans text-[#3E3E3E] font-syne text-[16px] tracking-[0.64px] font-light">
                      {item.tag}
                    </span>
                  </div>
                </Link>
                <Button
                  containerStyles="w-1/3 md:w-1/4 font-brandonMed mt-2 ml-auto border-[1px] border-primary p-2 text-primary text-[18px] hover:text-white hover:bg-primary"
                  path={item.path}
                >
                  learn more
                </Button>
