    ...
    <section className="relative overflow-hidden">
      ...
      <div className="hidden 3md:flex flex-col w-full -mt-20">
        ...
        <div className="flex w-full min-h-[118vh] ">
          <div className="w-full flex justify-center items-center bg-serviceSectionBg bg-cover bg-no-repeat">
            <div className="w-[26%] h-full flex justify-center items-center text-primary border-solid border-r-[2px] border-white gap-x-2 bg-[#292929]/90 backdrop-blur-[7.5px]">
              <span className="text-white text-[1.875rem] xl:text-[2.75rem] 3xl:text-[3rem] font-brandonMed text-shadow">
                WORK
              </span>
              <span className="text-white text-[1.875rem] xl:text-[2.75rem] 3xl:text-[3rem] font-brandonMed text-shadow">
                VALUE
            ...
            <div className="w-[40%] h-full flex flex-col justify-center px-[50px] 3xl:px-12 gap-y-[16px] 3xl:gap-y-[37px] bg-[#292929]/90 backdrop-blur-[7.5px]">
              <div className="flex items-center gap-x-10">
                ...
                <div className="flex flex-col gap-y-5">
                  <span className="text-white text-[1.25rem] xl:text-[1.5rem] font-sans font-medium tracking-[0.96px]">
                    概念探討
                  </span>
                  <span className="text-white text-[1rem] xl:text-[1.25rem] font-sans font-[350]">
                    為了能契合客戶的特殊須求與功能，透過意象的模擬與初步平面的規劃，以作為共同默契與討論基礎。
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-x-10">
                ...
                <div className="flex flex-col gap-y-5">
                  ...
                  <span className="text-white text-[1rem] xl:text-[1.25rem] font-sans font-[350]">
                    集合共同期望的特色與功能，經由設計者投入其經驗與專業知識，準確的呈現於解說圖面。透過圖說的詮釋，繪製出整套施工圖說與整體施工預算。
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-x-10">
                ...
                <div className="flex flex-col gap-y-5">
                  ...
                  <span className="text-white text-[1rem] xl:text-[1.25rem] font-sans font-[350]">
                    每日工程監造、定期回報與前置規劃，作為提高施工品質並管控施作進度的管理方式，並確保工程能和諧進行，減少衝突與如期完成。
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-x-10">
                ...
                <div className="flex flex-col gap-y-5">
                  ...
                  <span className="text-white text-[1rem] xl:text-[1.25rem] font-sans font-[350]">
                    有效率的提案，執著於創造更貼切的使用經驗。一次到位的方案選擇，反應實際的須求，享受專案服務的過程才是優先考量。
                  </span>
                </div>
              </div>
            </div>
              ...
              {PROCESSINFO.slice(0, 4).map((item, index) => (
                <li className=" relative flex gap-x-[6rem] mt-[40px] items-center" key={item.id}>
                  <div className="flex justify-center items-center bg-[#77A849] hover:bg-primary rounded-full w-[14.375rem] h-[14.375rem] z-10 group ease-linear duration-200">
                    <p className="absolute text-white font-syne tracking-[2.88px] text-[3rem] font-brandonBld text-shadow opacity-100 group-hover:opacity-0 ">
                      0{item.id}
                    </p>
                    <p className="absolute text-white font-syne tracking-[1.44px] text-[1.5rem] font-sans font-medium text-shadow opacity-0 group-hover:opacity-100 ">
                      {item.title}
                    </p>
                  </div>
        ...
        <div className="w-full h-[65vh] flex justify-center items-center bg-white">
          <div className="w-[26%] h-full flex justify-center items-center text-primary gap-x-2 ">
            <span className="text-primary text-[1.875rem] xl:text-[2.75rem] 3xl:text-[3rem] font-brandonMed text-shadow">
              CHARGES
            </span>
          </div>
          <div className="w-[80%] h-[80%] flex justify-center items-center gap-x-10">
            <div className="relative w-1/2 h-full justify-end items-end">
              ...
              <div className="absolute inset-0 mt-auto flex items-center h-[40%] w-full bg-primary/50 backdrop-blur-[2px] px-10 gap-x-4 z-10">
                <span className="text-white [writing-mode:vertical-lr] text-[1.25rem] xl:text-[1.5rem] font-medium leading-[31px] tracking-[6px]">
                  設計費
                </span>
                <div className="relative right-1 bottom-10 w-px p-[0.5px] h-[5rem] bg-white transform translate-y-1/2" />
                <div className="flex flex-col">
                  <span className="text-white text-[1rem] xl:text-[1rem] 3xl:text-[1.5rem] leading-loose 3xl:leading-[2.625rem] font-medium">
                    NT6,000/坪 - NT8,000/坪
                  </span>
                  <span className="text-white text-[0.75rem] xl:text-[0.75rem] 3xl:text-[1.25rem] leading-loose 3xl:leading-[2.5rem] font-sans font-[350] ">
                    依室內實際設計面積計算，設計總價最低為 NT120,000
                  </span>
                </div>
                <div></div>
              </div>
            ...
            <div className="relative w-1/2 h-full justify-end items-end">
              ...
              <div className="absolute inset-0 mt-auto flex items-center h-[40%] w-full bg-primary/50 backdrop-blur-[2px] px-10 gap-x-4 z-10">
                <span className="text-white [writing-mode:vertical-lr] text-[1.5rem] font-medium leading-[31px] tracking-[6px]">
                  工程費
                </span>
                <div className="relative  right-1 bottom-10 w-px p-[0.5px] h-[5rem] bg-white transform translate-y-1/2" />
                <div className="flex flex-col">
                  <span className="text-white text-[1rem] xl:text-[1rem] 3xl:text-[1.5rem] leading-normal xl:leading-loose 3xl:leading-[2.625rem] font-medium">
                    視裝修的屋況、屋齡、所選的設備和工程施作的難易度，以及，設計的面積、
                    性質、所選的材料和複雜度而有所不同。
                  </span>
                  <span className="text-white text-[0.75rem] xl:text-[0.75rem] 3xl:text-[1.25rem] leading-loose 3xl:leading-[2.5rem] font-sans font-[350] ">
                    費用區間依北部的裝修市場行情而定。
      ...
      <div className="3md:hidden flex flex-col w-full min-h-screen ">
        <div className="w-full h-full flex flex-col justify-center  gap-y-[2rem]  bg-[#292929]/90 backdrop-blur-[7.5px] px-8 pb-14">
          <h3 className="text-white text-[1.5rem] md:text-[3rem] font-brandonBld text-shadow pt-10 text-center">
            WORK VALUE
          </h3>
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <span className="text-white text-[1rem] font-sans font-[350] leading-[38px] tracking-[0.8px] text-shadow">
              為了能契合客戶的特殊須求與功能，透過意象的模擬與初步平面的規劃，以作為共同默契與討論基礎。
            </span>
          </div>
          <div className="flex flex-col gap-y-4">
        ...
        <div className="h-full w-full bg-[#D1D1D1]">
          ...
          <div className="flex flex-col w-full h-full justify-center gap-y-4">
            <h3 className="text-white text-[1.5rem] md:text-[3rem] font-brandonBld text-shadow pt-14 text-center">
              PROCESS
            </h3>
                  ...
                  .map((item, index) => (
                    <li className="relative flex gap-4 mt-[40px] items-center" key={item.id}>
                      <div className="flex justify-center items-center bg-[#77A849] hover:bg-primary rounded-full w-[8.5rem] h-[8.5rem] z-10 group">
                        <p className="absolute text-white font-syne tracking-[1.8px] text-[1.875rem] font-brandonBld text-shadow opacity-100 group-hover:opacity-0 ">
                          0{item.id}
                        </p>
                        <p className="absolute text-white font-syne tracking-[1.08px] text-[1.125rem] font-sans font-medium text-shadow opacity-0 group-hover:opacity-100">
                          {item.title}
                        </p>
                      </div>
                      {index !== PROCESSINFO.slice(0, 4).length - 1 && (
        ...
        <div className="h-full w-full">
          <div className="flex flex-col w-full h-full justify-center gap-y-4 pt-5">
            <h3 className="text-primary text-[1.5rem] md:text-[3rem] font-brandonBld text-shadow py-10 text-center">
              CHARGES
            </h3>
            <div className="flex flex-col gap-y-4">
              <div>
                <div className="relative w-full h-[48vh] md:h-[60vh] justify-end items-end">
                  ...
                  <div className="absolute inset-0 mt-auto flex flex-col items-center h-[70%] md:h-[60%] w-full bg-primary/50 backdrop-blur-[2px] px-10  gap-y-4 pt-8 z-10">
                    ...
                    <div className="flex flex-col  w-full gap-y-5 px-2 md:px-4 ">
                      <span className="text-white text-[1rem] tracing-[0.8px] font-sans text-shadow font-medium">
                        NT6,000/坪 - NT8,000/坪
                      </span>
                      <span className="text-white text-[1rem] leading-[26px] tracing-[0.8px] font-sans text-shadow font-[350] ">
                        依室內實際設計面積計算，設計總價最低為 NT120,000
                      </span>
                    </div>
                    <div></div>
                ...
                <div className="relative w-full h-[48vh] md:h-[60vh]  justify-end items-end mt-8 mb-16">
                  ...
                  <div className="absolute inset-0 mt-auto flex flex-col items-center h-[70%] md:h-[60%] w-full bg-primary/50 backdrop-blur-[2px] px-8 gap-y-4 pt-8 z-10">
                    ...
                    <div className="flex flex-col gap-y-5 px-2 md:px-4">
                      <span className="text-white text-[1rem] leading-[24px] tracing-[0.8px] font-sans text-shadow font-medium">
                        視裝修的屋況、屋齡、所選的設備和工程施作的難易度，以及，設計的面積、
                        性質、所選的材料和複雜度而有所不同。
                      </span>
                      <span className="text-white text-[1rem] leading-[26px] tracing-[0.8px] font-sans text-shadow font-[350] ">
