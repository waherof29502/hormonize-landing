      ...
      <div className="hidden 3md:flex w-full min-h-screen">
        <div className="flex flex-col">
          <div className="w-full h-3/4 flex justify-center items-center">
            <div
              ref={text}
              className="relative w-1/4 h-full flex flex-col justify-center items-center bg-[#D1D1D1] border-r-[2px] border-primary"
            >
              <span className="relative text-[1.875rem] md:text-[2.75rem] 3xl:text-[3.875rem] font-brandonLight text-shadow">
                SERVICE
              </span>
            ...
            <div
              ...
              className="w-1/2 h-full flex flex-col bg-white justify-center px-[3.125rem] 3xl:px-[5.625rem] gap-y-[1rem] 3xl:gap-y-[37px]"
            >
              <h2 className="text-primary text-[1.5rem] 3xl:text-[1.875rem] tracking-[1.8px] leading-[3rem] font-medium">
                朱慶煌
                <span className="text-primary text-[1rem] 3xl:text-[1.5rem] pl-2 font-medium text-shadow">
                  主持設計師
                </span>
              </h2>
              <span className="text-[#3E3E3E] text-[0.875rem] 3xl:text-[1.25rem] leading-[1.875rem] 3xl:leading-[2.25rem]">
                我們認為室內設計的重點，在於思考「生活」或「工作」的意義，透過如此的自我探究，使我們回到設計的原點，因為，生活空間或工作空間，必須反應出人類的最根本慾望。藉由設計手法，呈現每一個居住者或使用者的夢想，而不是無意義的樣式的複製而已。
              </span>
              <span className="text-[#3E3E3E] text-[0.875rem] 3xl:text-[1.25rem] leading-[1.875rem] 3xl:leading-[2.25rem]">
                對於我們的客戶來說，居住或工作空間，必須是健康、舒適且充滿活力的，散發居住者個性的，同時，必須達到合理預算的。所以，針對不同的需求，我們著重在創造出一個客製化的居住或工作環境，包括了適切且宜人的規劃，展現品味的風格設計，健康的材料選擇，環保與節能兼顧的品項採用，新穎與便利的設備推薦，以及，符合市場行情的建構費用。
              </span>
              <span className="text-[#3E3E3E] text-[0.875rem] 3xl:text-[1.25rem] leading-[1.875rem] 3xl:leading-[2.25rem]">
      ...
      <div className="3md:hidden flex flex-col w-full min-h-fit pb-20">
        <div className="flex flex-col gap-y-12 w-full justify-center items-center">
          ...
          <div className="w-full h-1/4 flex flex-col justify-center items-center text-primary border-solid border-r-[2px] border-primary gap-x-2">
            <span className="text-[1.875rem] md:text-[3rem] font-brandonLight text-shadow">SERVICE</span>
            <span className="text-[1.875rem] md:text-[3rem] font-brandonBld text-shadow">VALUE</span>
          </div>
