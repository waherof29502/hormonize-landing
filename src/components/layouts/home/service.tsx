        ...
        <div className="flex flex-col">
          <div className="w-full h-3/4 flex justify-center items-center">
            <div className="w-1/4 h-full flex flex-col justify-center items-center bg-[#D1D1D1] border-r-[2px] border-primary">
              <span className='text-[1.875rem] 3md:text-[2.5rem] xl:text-[3.875rem] font-brandonLight text-shadow'>SERVICE</span>
              <span className='text-[1.875rem] 3md:text-[2.5rem] xl:text-[3.875rem] font-brandonBld text-shadow'>VALUE</span>
            </div>
