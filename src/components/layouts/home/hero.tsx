...
const text = useRef(null);
  ...
  {/* desktop layout */}
        ...
        <h2 data-scroll data-scroll-speed="0.2" className="text-[2rem] xl:text-[2.5rem] 3xl:text-[3.1875rem] font-sans font-medium leading-normal text-shadow">擁有自己的天堂</h2>
        </div>          
      <div className="w-full flex absolute inset-0 mt-auto 3md:h-[41vh] lg:h-[39vh] xl:h-[32vh] 3xl:h-[30vh] wide:h-[22vh]">
          <div ref={text} className="relative w-1/4 h-full border-solid border-r-[2px] border-white">
          </div>
          <div data-scroll data-scroll-speed="0.2" className="w-1/2 h-full flex flex-col px-[5.9375rem] lg:px-[3.5rem] 3xl:px-[5.9375rem] gap-y-[2.3125rem]">
