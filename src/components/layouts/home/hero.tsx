...
export default function Hero() {
  ...
  {/* desktop layout */}
        ...
        <h2 className="lg:text-[2rem] xl:text-[3rem] 3xl:text-[3.1875rem] font-sans font-medium leading-normal text-shadow">擁有自己的天堂</h2>
        </div>          
      <div className="w-full flex absolute inset-0 mt-auto h-[72%]">
          ...
          <div className="w-1/2 h-full flex flex-col px-[5.9375rem] gap-y-[2.3125rem]">
            <h2 className="font-sans text-white text-[1rem] 3xl:text-[1.25rem] wider:text-[1.5rem] font-normal leading-[2.5rem] text-shadow">
            以居家住宅為主要範圍，從室內設計到工程施工，我們提供一個全方位統包的工作內容。內容包含：空間的規劃與設計、新居裝修、舊屋翻新、客廳設計、廚房及餐廳設計...</h2>
            <Button containerStyles='font-brandonMed ml-auto border-[1px] border-white px-5 py-2 text-[1.25rem] 3xl:text-[1.5rem] hover:text-primary hover:bg-white' path="/projects">see all projects</Button>
          </div>
