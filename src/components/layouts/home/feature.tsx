    ...
    <section className="relative overflow-hidden">
      ...
      <div className="hidden 3md:flex w-full min-h-[90vh] bg-feature bg-cover bg-no-repeat">
        <div className="w-full flex justify-center items-center">
          <div
            ref={text}
            className="relative w-1/4 h-full flex flex-col justify-center items-center text-white border-solid border-r-[2px] border-white"
          >
          ...
          <div
            ...
            className="w-1/2 h-full flex flex-col justify-center pl-[3.125rem] 3xl:pl-[5.625rem] gap-y-[1rem] 3xl:gap-y-[2.3125rem]"
          >
