...
export default function Feature() {
  return (
    <section className="relative">
      <div className="flex w-full min-h-[90vh] bg-feature bg-cover bg-no-repeat">
        <div className="w-full flex justify-center items-center">
          ...
          <div className="w-1/2 h-full flex flex-col justify-center px-[90px] gap-y-[37px]">
            <h2 className="text-white text-[30px] tracking-[1.8px] leading-[48px] font-medium">
              設計空間是須要專注的。
            </h2>
