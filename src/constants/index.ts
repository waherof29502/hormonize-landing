...
export const PROJECTITEM = [
  { imgSrc: '/images/home/1-1.png',imgProjectSrc:'/images/project/1-1.png', title: '共居 x 共鳴‧竹北', icon: React.createElement(BoxIcon), tag: '辦公空間',category:['residential'] ,path:"/project-hsinchu",projectTag:'住宅空間'},
  { imgSrc: '/images/home/1-2.png',imgProjectSrc:'/images/project/1-2.png', title: '四立方‧彰化', icon: React.createElement(BoxIcon), tag: '住宅空間' ,category:['single', 'building'],path:"/project-changhua",projectTag:'獨棟建築'},
  { imgSrc: '/images/home/1-3.png',imgProjectSrc:'/images/project/1-3.png', title: '雲之端‧台北內湖', icon: React.createElement(BoxIcon), tag: '辦公空間',category:['commercial' ,'space'],path:"/project-taipei",projectTag:'商業空間'}
] as const;

export const PROJECTMOBILEITEM = [
  { imgSrc: '/images/home/1-2.png', title: '四立方‧彰化', icon: React.createElement(BoxIcon), tag: '辦公空間',path:"/project-changhua"},
  { imgSrc: '/images/home/1-1.png', title: '共居 x 共鳴‧竹北', icon: React.createElement(BoxIcon), tag: '辦公空間',path:"/project-hsinchu" },
  { imgSrc: '/images/home/1-3.png', title: '雲之端‧台北內湖', icon: React.createElement(BoxIcon), tag: '辦公空間',path:"/project-taipei" }
] as const;
