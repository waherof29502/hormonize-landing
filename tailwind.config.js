  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        aboutUsHero:'url(/images/about/bg-hero.png)',
        ...
        blogHero:'url(/images/blog/bg-hero.png)',
        mobileBlogHero:'url(/images/blog/mobile/bg-hero.png)',
        privacyHero:'url(/images/privacy/bg-hero.png)',
        mobilePrivacyHero:'url(/images/privacy/mobile/bg-hero.png)',
